...
import { NavGroupType } from '@materialize/@layouts/types'

defineOptions({
  inheritAttrs: false,
})

const LazyAppBarSearch = defineAsyncComponent(() => import('@materialize/@core/components/AppBarSearch.vue'))
...
<style lang="scss">
@use "@materialize/styles/variables/vuetify.scss";
