...
import borderSkinDark from '@materialize/images/customizer-icons/border-dark.svg'
import borderSkinLight from '@materialize/images/customizer-icons/border-light.svg'
import collapsedDark from '@materialize/images/customizer-icons/collapsed-dark.svg'
import collapsedLight from '@materialize/images/customizer-icons/collapsed-light.svg'
import compactDark from '@materialize/images/customizer-icons/compact-dark.svg'
import compactLight from '@materialize/images/customizer-icons/compact-light.svg'
import defaultSkinDark from '@materialize/images/customizer-icons/default-dark.svg'
import defaultSkinLight from '@materialize/images/customizer-icons/default-light.svg'
import horizontalDark from '@materialize/images/customizer-icons/horizontal-dark.svg'
import horizontalLight from '@materialize/images/customizer-icons/horizontal-light.svg'
import ltrDark from '@materialize/images/customizer-icons/ltr-dark.svg'
import ltrLight from '@materialize/images/customizer-icons/ltr-light.svg'
import rtlDark from '@materialize/images/customizer-icons/rtl-dark.svg'
import rtlLight from '@materialize/images/customizer-icons/rtl-light.svg'
import wideDark from '@materialize/images/customizer-icons/wide-dark.svg'
import wideLight from '@materialize/images/customizer-icons/wide-light.svg'
import { useConfigStore } from '@materialize/@core/stores/config'
import { Direction, Layout, Skins, Theme } from '@materialize/@core/enums'
import { cookieRef, namespaceConfig } from '@materialize/@layouts/stores/config'
import { AppContentLayoutNav, ContentWidth } from '@materialize/@layouts/enums'
import { themeConfig } from '@materialize/config'
import { staticPrimaryColor, staticPrimaryDarkenColor } from '@materialize/plugins/vuetify/theme'
