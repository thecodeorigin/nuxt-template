...
import frontPageVectorImg from '@materialize/images/svg/front-page-vector.svg'
import ListArrowIcon from '@materialize/images/svg/list-arrow-icon.svg'
import VectorIcon from '@materialize/images/svg/vector.svg'
