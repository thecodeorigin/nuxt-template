...
import sectionTitleIcon from '@materialize/images/pages/section-title-icon.png'
import { useTheme } from 'vuetify'

import logo2dark from '@materialize/images/front-pages/branding/logo-2-dark.png'
import logo2light from '@materialize/images/front-pages/branding/logo-2-light.png'
import logo2 from '@materialize/images/front-pages/branding/logo-2.png'
