...
import { HorizontalNavLink, HorizontalNavPopper } from '@materialize/@layouts/components'
import { useLayoutConfigStore } from '@materialize/@layouts/stores/config'
import type { NavItem } from '@materialize/@layouts/types'
import { getDynamicI18nProps, isNavGroupActive } from '@materialize/@layouts/utils'
