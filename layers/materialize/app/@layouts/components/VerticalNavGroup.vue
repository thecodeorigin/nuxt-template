...
import { TransitionExpand, VerticalNavLink } from '@materialize/@layouts/components'
...
import { getDynamicI18nProps, isNavGroupActive, openGroups } from '@materialize/@layouts/utils'
