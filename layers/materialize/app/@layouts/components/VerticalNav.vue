...
import { VerticalNavGroup, VerticalNavLink, VerticalNavSectionTitle } from '@materialize/@layouts/components'
import { useLayoutConfigStore } from '@materialize/@layouts/stores/config'
import { injectionKeyIsVerticalNavHovered } from '@materialize/@layouts/symbols'
...
<style lang="scss">
@use "@materialize/configured-variables" as variables;
@use "@materialize/@layouts/styles/mixins";
