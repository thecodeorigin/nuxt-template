import VerticalNavHeaderArrow from '@materialize/images/svg/vertical-nav-header-arrow.svg'
import { breakpointsVuetifyV3 } from '@vueuse/core'
import { VIcon } from 'vuetify/components/VIcon'

// ❗ Logo SVG must be imported with ?raw suffix
import logo from '@materialize/images/logo.svg?raw'
import { Skins } from '@materialize/@core/enums'
import { AppContentLayoutNav, ContentWidth, FooterType, NavbarType } from '@materialize/@layouts/enums'
import { defineThemeConfig } from '@materialize/@core'
