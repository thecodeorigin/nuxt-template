...
import authV1LoginMaskDark from '@materialize/images/pages/auth-v1-login-mask-dark.png'
import authV1LoginMaskLight from '@materialize/images/pages/auth-v1-login-mask-light.png'
