...
import type { BannerSectionType, ContactUsSectionType, CustomerReviewSectionType, FAQSectionType, FeatureSectionType, HeroSectionType, LandingPage, PricingSectionType, ProductStatsSectionType, TeamSectionType } from '@base/utils/types/landing-page'
...
export const useLandingPageStore = defineStore('landing-page', () => {
  ...
  watch(() => landingPageData.value, (data) => {
    if (data) {
      heroData.value = pick(data, ['hero_title', 'hero_title_desc', 'hero_main_img_dark', 'hero_main_img_light', 'hero_sub_img_dark', 'hero_sub_img_light', 'hero_title_button']) as HeroSectionType

      featureData.value = pick(data, ['feature_title', 'feature_title_desc', 'feature_data']) as FeatureSectionType
