...
import borderSkinDark from '@base/images/customizer-icons/border-dark.svg'
import borderSkinLight from '@base/images/customizer-icons/border-light.svg'
import collapsedDark from '@base/images/customizer-icons/collapsed-dark.svg'
import collapsedLight from '@base/images/customizer-icons/collapsed-light.svg'
import compactDark from '@base/images/customizer-icons/compact-dark.svg'
import compactLight from '@base/images/customizer-icons/compact-light.svg'
import defaultSkinDark from '@base/images/customizer-icons/default-dark.svg'
import defaultSkinLight from '@base/images/customizer-icons/default-light.svg'
import horizontalDark from '@base/images/customizer-icons/horizontal-dark.svg'
import horizontalLight from '@base/images/customizer-icons/horizontal-light.svg'
import ltrDark from '@base/images/customizer-icons/ltr-dark.svg'
import ltrLight from '@base/images/customizer-icons/ltr-light.svg'
import rtlDark from '@base/images/customizer-icons/rtl-dark.svg'
import rtlLight from '@base/images/customizer-icons/rtl-light.svg'
import wideDark from '@base/images/customizer-icons/wide-dark.svg'
import wideLight from '@base/images/customizer-icons/wide-light.svg'
import { useConfigStore } from '@base/@core/stores/config'
import { Direction, Layout, Skins, Theme } from '@base/@core/enums'
...
const setPrimaryColor = useDebounceFn((color: { main: string, darken: string }) => {
  if (vuetifyTheme.themes.value[vuetifyTheme.name.value]) {
...
const isActiveLangRTL = computed(() => localeProperties.value.dir === 'rtl')
