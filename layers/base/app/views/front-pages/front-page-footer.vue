...
import appleImg from '@base/images/front-pages/landing-page/apple-icon.png'
import googlePlayImg from '@base/images/front-pages/landing-page/google-play-icon.png'
...
.footer-top {
  background: url("@base/images/front-pages/backgrounds/footer-bg.png") lightgray 50% / cover no-repeat;
}
