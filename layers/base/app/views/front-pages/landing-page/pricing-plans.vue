...
import ListArrowIcon from '@base/images/svg/list-arrow-icon.svg'
import VectorIcon from '@base/images/svg/vector.svg'
import type { PlanData } from '@base/utils/types/landing-page'
