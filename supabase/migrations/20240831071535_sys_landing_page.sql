...
create table "public"."sys_landing_page" (
    ...
    "banner_title" text,
    "banner_title_desc" text,
    "banner_button" text,
    "banner_img" text,
    "contact_us_card_title" text
);
...
CREATE UNIQUE INDEX title ON public.sys_landing_page USING btree (pricing_data);
...
alter table "public"."sys_landing_page" add constraint "title" UNIQUE using index "title";
