...
import darkBg from '@base/images/front-pages/backgrounds/hero-bg-dark.png'
import lightBg from '@base/images/front-pages/backgrounds/hero-bg.png'
import heroDashboardImgDark from '@base/images/front-pages/landing-page/hero-dashboard-dark.png'
import heroDashboardImgLight from '@base/images/front-pages/landing-page/hero-dashboard-light.png'
import heroElementsImgDark from '@base/images/front-pages/landing-page/hero-elements-dark.png'
import heroElementsImgLight from '@base/images/front-pages/landing-page/hero-elements-light.png'
import { useGenerateImageVariant } from '@base/@core/composable/useGenerateImageVariant'
import type { HeroButtonType } from '@base/utils/types/landing-page'
...
@use "@base/@layouts/styles/mixins" as layoutMixins;
