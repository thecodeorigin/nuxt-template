...
import logo2dark from '@base/images/front-pages/branding/logo-2-dark.png'
import logo2light from '@base/images/front-pages/branding/logo-2-light.png'
import logo2 from '@base/images/front-pages/branding/logo-2.png'

import { useGenerateImageVariant } from '@base/@core/composable/useGenerateImageVariant'
import type { CustomerReview } from '@base/utils/types/landing-page'
