...
import { kFormatter } from '@base/@core/utils/formatters'
import type { ProductStatType } from '@base/utils/types/landing-page'
import { iconMappings } from '@base/utils/landingPageUtils.js'
