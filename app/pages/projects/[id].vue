...
import ProjectInfor from '@/app/components/project/detail/ProjectInfor.vue'
import ProjectSubtitleGroup from '@/app/components/project/detail/subtitle/ProjectSubtitleGroup.vue'
